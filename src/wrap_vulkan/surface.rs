...
use ash::{extensions::khr::Surface, vk::{SurfaceKHR, SurfaceCapabilitiesKHR, SurfaceFormatKHR, PresentModeKHR, PhysicalDevice}, Entry, Instance};
...
impl SurfaceRelated {
    pub fn new(entry: &Entry, instance: &Instance, physical_device: PhysicalDevice, window: &Window) -> Result<Self> {
